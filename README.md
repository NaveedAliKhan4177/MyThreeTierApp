...
In the Jenkins-Pipeline-Code directory, you'll find Jenkins pipeline scripts.
These scripts automate the CI/CD process, ensuring smooth integration and deployment of your application.
...
To get started with this project, refer to our comprehensive guide

that walks you through IAM user setup, infrastructure provisioning, CI/CD pipeline configuration, EKS cluster creation, and more.
...
Launch an Ubuntu instance in your favourite region (e.g., us-west-2)
...
🧾 To clean up the rest and avoid extra costs:
Stop or Terminate the EC2 instance created in Step 2.  
Delete the Load Balancer created in Step 9 and 10.  
Go to EC2 Console → Security Groups section → Delete groups created earlier.  
